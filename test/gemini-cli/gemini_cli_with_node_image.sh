...
# This test file will be executed against the 'gemini_cli_with_node_image' scenario
# to verify that Gemini CLI is properly installed on a Node.js base image.
